...
let g:terminal_ansi_colors = ['#080808', '#cc241d', '#98971a', '#d79921', '#458588', '#b16286', '#689d6a', '#a89984', '#928374', '#fb4934', '#b8bb26', '#fabd2f', '#83a598', '#d3869b', '#8ec07c', '#ebdbb2']
endif
hi Normal guifg=#ebdbb2 guibg=#080808 gui=NONE cterm=NONE
hi CursorLineNr guifg=#fabd2f guibg=#080808 gui=bold cterm=bold
hi FoldColumn guifg=#928374 guibg=#080808 gui=NONE cterm=NONE
hi SignColumn guifg=#928374 guibg=#080808 gui=NONE cterm=NONE
hi VertSplit guifg=#303030 guibg=#080808 gui=NONE cterm=NONE
hi ColorColumn guifg=NONE guibg=#000000 gui=NONE cterm=NONE
hi Comment guifg=#928374 guibg=NONE gui=NONE cterm=NONE
hi CursorLine guifg=NONE guibg=#303030 gui=NONE cterm=NONE
hi Error guifg=#fb4934 guibg=#080808 gui=bold,reverse cterm=bold,reverse
hi ErrorMsg guifg=#080808 guibg=#fb4934 gui=bold cterm=bold
...
hi Visual guifg=#080808 guibg=#83a598 gui=NONE cterm=NONE
...
hi Cursor guifg=#080808 guibg=#fbf1c7 gui=NONE cterm=NONE
hi DiffAdd guifg=#b8bb26 guibg=#080808 gui=reverse cterm=reverse
hi DiffChange guifg=#8ec07c guibg=#080808 gui=reverse cterm=reverse
hi DiffDelete guifg=#fb4934 guibg=#080808 gui=reverse cterm=reverse
hi DiffText guifg=#fabd2f guibg=#080808 gui=reverse cterm=reverse
hi Directory guifg=#b8bb26 guibg=NONE gui=bold cterm=bold
hi IncSearch guifg=#fe8019 guibg=#080808 gui=reverse cterm=reverse
...
hi Search guifg=#98971a guibg=#080808 gui=reverse cterm=reverse
hi QuickFixLine guifg=#8ec07c guibg=#080808 gui=reverse cterm=reverse
...
hi Todo guifg=fg guibg=#080808 gui=bold cterm=bold
...
hi CursorIM guifg=#080808 guibg=#fbf1c7 gui=NONE cterm=NONE
